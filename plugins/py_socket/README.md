...
| `plugin`     | Entry-point plugin class (`IPlugin`) and runtime orchestrator              |
...
3. **Contract Conformance** — fully conforms to `IPlugin`, `IPluginRuntime`, and `IConnection` interfaces.
